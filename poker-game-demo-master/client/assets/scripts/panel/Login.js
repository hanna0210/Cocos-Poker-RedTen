...
cc.Class({
    ...
    onLoad: function () {
        ...
        // 获得IP地址 - commented out as IP server is not running
        // this.getIpAddress();
        
        // Set default IP if not available
        if (!hongshi.userData.ip) {
            hongshi.userData.ip = "127.0.0.1";
        }
    ...
    onClickWeiXinLogin: function () {
        hongshi.serverAddress = 'ws://localhost:8011';
        SDKManager.login();
    },
